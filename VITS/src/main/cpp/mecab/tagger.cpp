...
class ModelImpl: public Model {
 public:
  ...
  bool open(AssetJNI* asjni, int argc, char **argv);
  bool open(AssetJNI* asjni, const char *arg);
  bool open(const Param &param, AssetJNI* asjni);
...
bool ModelImpl::open(AssetJNI* asjni, int argc, char **argv) {
  Param param;
  ...
  return open(param, asjni);
}

bool ModelImpl::open(AssetJNI* asjni, const char *arg) {
  Param param;
...
bool ModelImpl::open(const Param &param, AssetJNI* asjni) {
  if (!writer_->open(param) || !viterbi_->open(param, asjni)) {
...
bool TaggerImpl::open(AssetJNI* asjni,int argc, char **argv) {
  model_.reset(new ModelImpl);
  if (!model_->open(asjni, argc, argv)) {
    model_.reset(0);
    return false;
  }
...
bool TaggerImpl::open(AssetJNI* asjni,const char *arg) {
  model_.reset(new ModelImpl);
  if (!model_->open(asjni, arg)) {
    model_.reset(0);
    return false;
  }
  current_model_ = model_.get();
...
Tagger *Tagger::create(AssetJNI* asjni, int argc, char **argv) {
  return createTagger(asjni, argc, argv);
}

Tagger *Tagger::create(AssetJNI* asjni,const char *arg) {
  return createTagger(asjni, arg);
}
...
Tagger *createTagger(AssetJNI* asjni,int argc, char **argv) {
  TaggerImpl *tagger = new TaggerImpl();
  if (!tagger->open(asjni, argc, argv)) {
    setGlobalError(tagger->what());
    delete tagger;
    return 0;
  }
...
Tagger *createTagger(AssetJNI* asjni, const char *argv) {
  TaggerImpl *tagger = new TaggerImpl();
  if (!tagger->open(asjni, argv)) {
    setGlobalError(tagger->what());
    delete tagger;
    return 0;
  }
...
Model *createModel(AssetJNI* asjni, int argc, char **argv) {
  ModelImpl *model = new ModelImpl;
  if (!model->open(asjni, argc, argv)) {
    delete model;
    return 0;
  }
  return model;
...
Model *createModel(AssetJNI* asjni,const char *arg) {
  ModelImpl *model = new ModelImpl;
  if (!model->open(asjni, arg)) {
    delete model;
    return 0;
  }
  return model;
...
Model *Model::create(AssetJNI* asjni,int argc, char **argv) {
  return createModel(asjni, argc, argv);
}

Model *Model::create(AssetJNI* asjni, const char *arg) {
  return createModel(asjni, arg);
}
...
int mecab_do(AssetJNI* asjni, int argc, char **argv) {
